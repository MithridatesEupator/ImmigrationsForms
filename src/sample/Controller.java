...
public class Controller implements Initializable {
    ...
    public void SaveVars() throws Exception {
        ...
        String TenantInfoLine = "";
        if (!TenantInfo.trim().isEmpty()) {
            TenantInfoLine += TenantInfo + " #" + AddInfoAddress;
        }
        AddressLine1 = AddressStreet + " " + TenantInfoLine;
    ...
    public void fillAppHelper() throws Exception {
        ...
        String[] checkArray = {AGender, TenantInfo, AltTenantInfo, lastArrived, ImmigrationStatus, TenantInfo1, TenantInfo2,
                ("E" + workInfoEntry.Root.AddressAddInfo), ("E" + workInfoEntry.Root.NextNode.AddressAddInfo + "1"), ("E" + workInfoEntry.Root.NextNode.NextNode.AddressAddInfo + "2"),
                MaritalStatus, USGuard, SApply, C1status, C2status, C3status, Ethnicity, Race, EyeColor, HairColor, OrgAnswer, DisabilityAnswer, InterpreterQuestion, ITenantInfo,
                PTenantInfo, Q49, Q55, Q61, Q62, SocialSecurityBox, C4status, C5status, C6status, C7status, applyI765, nameChange, reason, disability, disabilityExtra};
