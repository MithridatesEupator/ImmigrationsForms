...
public class Controller implements Initializable {
    ...
    public TextField clientIncome;
    public Text Benefit1;
    public Text Benefit2;
    public Text Benefit3;
    public Text[] BenefitsList = new Text[3];
    public TextField clientBenefitDate;
    public Text BenefitDate1;
    public Text BenefitDate2;
    public Text BenefitDate3;
    public Text[] BenefitsDateList = new Text[3];
    private Stage stage;
    ...
    String FCityBirth = "";
    String FCountryBirth = "";
    String FCityCurrent = "";
    String FCountryCurrent = "";
    String MFamilyName = "";
    String MFirstName = "";
    String MMiddleName = "";
    String MFamilyNameB = "";
    ...
    String MCityBirth = "";
    String MCountryBirth = "";
    String MCityCurrent = "";
    String MCountryCurrent = "";
    String MarriageNum = "";
    String SFamilyName = "";
    String SMiddleName = "";
    String SFirstName = "";
    ...
    String SMarriageDate = "";
    String SCityBirth = "";
    String SCountryBirth = "";
    String DFamilyName = "";
    String DFirstName = "";
    String DMiddleName = "";
    String DBirthCountry = "";
    DateValue DDOBDate = new DateValue();
    DateValue DMarriageDate = new DateValue();
    String DCityMarriage = "";
    String DStateMarriage = "";
    String DCityDivorced = "";
    String DStateDivorced = "";
    DateValue DMarriageEndDate = new DateValue();
    String DCountryDivorced = "";
    String DCountryMarriage = "";
    String SCityMarriage = "";
    String SCountryMarriage = "";
    String ChildNum = "";
    static String ChildNumReference = "";
    String C1FamilyName = "";
    String C1MiddleName = "";
    String C1FirstName = "";
    String C1ANum = "";
    ...
    String CityOrganization = "";
    String StateOrganization = "";
    String CountryOrganization = "";
    String NatureOrganization = "";
    DateValue OrganizationStartDate = new DateValue();
    DateValue OrganizationEndDate = new DateValue();
    String NameOrganization1 = "";
    String CityOrganization1 = "";
    String StateOrganization1 = "";
    String CountryOrganization1 = "";
    String NatureOrganization1 = "";
    DateValue OrganizationStartDate1 = new DateValue();
    DateValue OrganizationEndDate1 = new DateValue();
    String NameOrganization2 = "";
    String CityOrganization2 = "";
    String StateOrganization2 = "";
    String CountryOrganization2 = "";
    String NatureOrganization2 = "";
    ...
    String IFamilyName = "";
    String IFirstName = "";
    String IOrganizationName = "";
    String IAddressStreet = "";
    String IAddInfoAddress = "";
    String IAddressCity = "";
    String IState = "";
    String IZipcode = "";
    String ICountry = "";
    ...
    String Addendum4I = "";
    String Addendum4J = "";
    String EntryInspectionStatus = "";
    String EntryParoledStatus = "";
    String OtherStatus = "";
    String EntryI765 = "";
    String AGender = "";
    String TenantInfo = "";
    ...
    static String C1Gender = "";
    static String C1FamilyName1 = "";
    static String C1FirstName1 = "";
    static String C1MiddleName1 = "";
    static String C1PD1 = "";
    static String C1PD2 = "";
    static String C1PD3 = "";
    static String C1Feet = "";
    static String C1Inches = "";
    static String C1Ethnicity = "";
    static String C1Race = "";
    static String C1HairColor = "";
    static String C1EyeColor = "";
    static String C1Weight = "";
    static String C1Height = "";
    static String C2Gender = "";
    static String C2FamilyName1 = "";
    static String C2FirstName1 = "";
    static String C2MiddleName1 = "";
    static String C2PD1 = "";
    static String C2PD2 = "";
    static String C2PD3 = "";
    static String C2Feet = "";
    static String C2Inches = "";
    static String C2Ethnicity = "";
    static String C2Race = "";
    static String C2HairColor = "";
    static String C2EyeColor = "";
    static String C2Weight = "";
    static String C2Height = "";
    static String C3Gender = "";
    static String C3FamilyName1 = "";
    static String C3FirstName1 = "";
    static String C3MiddleName1 = "";
    static String C3PD1 = "";
    static String C3PD2 = "";
    static String C3PD3 = "";
    static String C3Feet = "";
    static String C3Inches = "";
    static String C3Ethnicity = "";
    static String C3Race = "";
    static String C3HairColor = "";
    static String C3EyeColor = "";
    static String C3Weight = "";
    static String C3Height = "";
    static String SGender = "";
    static String hairIdentifier = "";
    static String eyeIdentifier = "";
    static String C1SpouseNumber = "";
    static String C2SpouseNumber = "";
    static String C3SpouseNumber = "";
    ...
    String[] ethnicityArray = {"ARGENTINA","ARGENTINIAN","URUGUAY","URUGUAYANS","PARAGUAY","PARAGUAYANS","TUNIS","TUNISIAN","IRAQ","IRAQI","JORDAN","JORDANIAN","SYRIA","SYRIAN","CUBA","CUBAN",
            ...
            "BENGALI","UGANDA","UGANDAN","RWANDA","RWANDAN","BURUNDI","BURUNDIAN","UNITED ARAB EMIRATES","EMIRATI","UAE","EMIRATI","OMAN","OMANI","QATAR","QATARI","KUWAIT","KUWAITI"};
    ...
    public void initialize(URL location, ResourceBundle resources) {
        BenefitsList[0] = Benefit1;
        BenefitsList[1] = Benefit2;
        BenefitsList[2] = Benefit3;
    ...
    public Scene getShadowScene(Parent parent) {
        ...
        parent.setEffect(new DropShadow(javafx.scene.effect.BlurType.GAUSSIAN, Color.rgb(0,0,0,.65), 15, 0, 0, 0));
    ...
    public void readJSON() throws org.json.simple.parser.ParseException, IOException {
        ...
        PDayTimeNum = PMobNum;
        PreparerName = PFirstName + " " + PFamilyName;
    ...
    public void addSSI(ActionEvent event) {
        benefitsNum++;
        BenefitsList[benefitsNum].setText("SSI");
    }
    public void addMedicaid(ActionEvent event) {
        benefitsNum++;
        BenefitsList[benefitsNum].setText("Medicaid");
    }
    public void addFoodStamps(ActionEvent event) {
        benefitsNum++;
        BenefitsList[benefitsNum].setText("Food Stamps");
    }
    public void setClear(ActionEvent event) {
        benefitsNum = -1;
        BenefitsList[0].setText("");
        BenefitsList[1].setText("");
        BenefitsList[2].setText("");
        BenefitsDateList[0].setText("");
        BenefitsDateList[1].setText("");
        BenefitsDateList[2].setText("");
    }

    public void addBenefitsDate(ActionEvent event) {
        BenefitsDateList[benefitsNum].setText(clientBenefitDate.getText().trim());
    }
    ...
    public void SaveVars() throws Exception {
        ...
        if(!clientIncome.getText().trim().isEmpty()) {
            try {
                baseIncome = (double) Integer.parseInt(clientIncome.getText().trim());
            }
            catch (NumberFormatException ex) {
                baseIncome = (double) Integer.parseInt(clientIncome.getText().trim().replace(",",""));
            }
            needI912 = true;
        }
    }
    ...
    public void fileI912() throws Exception {
        if(needI912) {
            if (workInfoEntry.Root.Employer.trim().toUpperCase().equals("UNEMPLOYED")) {
            ...
            String[] nameFieldArrayIncome = {"AnnualIncome", "FamilyIncome", "FinancialSupport", "TotalIncome", "NameH", "DateDOBH", "NameH1", "DateDOBH1", "RelationshipH1", "NameH2", "DateDOBH2", "RelationshipH2", "NameH3", "DateDOBH3", "RelationshipH3", "HouseholdSize"};
            ...
            if(Reason.equals("Income")) {
                ...
                nameFieldArrayMain = functions.extend(nameFieldArrayMain, nameFieldArrayIncome);
            }
            else {
            ...
            if(Reason.equals("Income")) {
                ...
                checkArrayMain = functions.extend(checkArrayMain, checkArrayBenefit);
            }
            InputStream in = getClass().getResourceAsStream("resources/pdf/i-912.pdf");
            PDDocument document = PDDocument.load(in);
            PDDocumentCatalog docCatalog = document.getDocumentCatalog();
            PDAcroForm acroForm = docCatalog.getAcroForm();
            for (int i = 0; i < fieldArrayMain.length; i++) {
                String entryFieldArray = fieldArrayMain[i];
                String entryNameArray = nameFieldArrayMain[i];
                try {
                    PDField fieldTemp = acroForm.getField(entryNameArray);
                    if (fieldTemp != null) {
                        fieldTemp.setValue(entryFieldArray.toUpperCase());
            ...
            for (int b = 0; b < checkArrayMain.length; b++) {
                String entryCheckArray = checkArrayMain[b];
                if (!entryCheckArray.trim().isEmpty()) {
                    try {
                        PDCheckBox boxTemp = (PDCheckBox) acroForm.getField(entryCheckArray);
                        boxTemp.check();
